...
namespace AI_cars_Map_Testing
{
    ...
    public class Game1 : Game
    {
        ...
        {  
            ...
            blocks[0].Position = new Vector3(-40, -40, 0);
            blocks[1].Position = new Vector3(-40, 0, 0);
            blocks[2].Position = new Vector3(40, -40, 0);
            blocks[3].Position = blocks[1].Position;
            blocks[4].Position = new Vector3(40, 0, 0);
            blocks[5].Position = blocks[2].Position;
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            foreach (EffectPass pass in basicEffect.CurrentTechnique.Passes)
            {
                ...
                graphics.GraphicsDevice.DrawUserPrimitives(PrimitiveType.TriangleList, blocks, 0, 2);
            }
